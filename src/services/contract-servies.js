...
class ContractServies {
	...
	constructor() {
		this.web3 = null;
		this.provider = localStorage.getItem('chainInfo') ? JSON.parse(localStorage.getItem('chainInfo')).url : 'http://192.168.10.72:6789'; //节点地址18
		this.privateKey = ''; //用户私钥 4e617c514bd6c037c29850a6be302288abaac30d8d2049157cb2b15c5bcc4e2e
	...
	addContract(contractName, ABI, address, version = '0.0.1.0', moduleName = 'SystemModuleManager', moduleVersion = '0.0.1.0') {
		console.log("出来",contractName,ABI,address)
		//内置合约是否注册
...
//			queryAddress = register.getContractAddress.call(moduleName, moduleVersion, contractName, version);
			...
			console.log("address",contractName,queryAddress)
	...
	call(contractName, methodName, argumentList) { //address 合约地址
		try {
			...
			console.log("看这里：",KeyServies)
			//加上from
			console.log("getAddress",KeyServies.getAddress());
			argumentList.push({
				from: "0x97928f37cf95527551b1501bc3a1df658bbbd56e"
