          ...
          <table class="table odd">
            <tbody>
              <tr>
                ...
                <td>法人姓名</td>
                <td>{{listone.corporation}}</td>
                <td>
                  法人电话
                </td>
                <td>{{listone.corporationTel}}</td>
              </tr>
              <tr>
                <td>
                  法人邮箱
                </td>
                <td>{{listone.corporationEmiall}}</td>
                <td>公司网址</td>
                <td>{{listone.webSite}}</td>
              </tr>
              <tr>
                <td>
                  注册日期
                </td>
                <td>{{listone.registerDate}}</td>
                <td>注册资本</td>
                <td>{{listone.registerCapital}}</td>
              </tr>
            ...
            <table class="table odd">
              <tbody>
                <tr>
                  ...
                  <td>{{listone.registerAddress}}</td>
                  <td>经营范围</td>
                  <td>{{listone.scopeOfBusiness}}</td>
                </tr>
                <tr>
                  <td>
                    注册地址
                  </td>
                  <td colspan="4" class="tb2Td">{{listone.nationality}}+{{listone.provinceName}}+{{listone.cityName}}+{{listone.registerAddress}}</td>
...
export default {
  ...
  created() {
    ...
    // ApiService.business.queryCustInfo({
    //   seq: 'Math.random()*100000000000000000000',
    //   userId: '',
    //   timestamp: 0
    // }).then((res) => {
    //   console.log(res)
    //   // this.name = res.msg.data.name
    //   this.custTypeName = res.msg.data.custTypeName
    //   this.capitalAccount = res.msg.data.capitalAccount
    //   this.account = res.msg.data.account
    //   this.name = res.msg.data.name
    //   this.certType = res.msg.data.certType
    //   this.certNo = res.msg.data.certNo
    //   this.mobile = res.msg.data.mobile
    //   this.contactNo = res.msg.data.contactNo
    //   this.contactPhone = res.msg.data.contactPhone
    //   this.address = res.msg.data.address
