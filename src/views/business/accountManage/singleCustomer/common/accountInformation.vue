          ...
          <table class="table odd">
            <tbody>
              <tr>
                ...
                <td class="table-self">客户代码</td>
                <td class="table-self">客户名称</td>
                <td class="table-self">资金账户</td>
              </tr>
              <tr>
                <td>
                  1
                </td>
                <td>{{listone.custno}}</td>
                <td>{{listone.name}}</td>
            ...
            <table class="table odd">
              <tbody class="table1">
                <tr>
                  ...
                  <td class="table-self">客户代码</td>
                  <td class="table-self">客户名称</td>
                  <td class="table-self">登记账户</td>
                  <td class="table-self">登记机构</td>
                  <td class="table-self">账户状态</td>
                  <td class="table-self">开户日期</td>
                </tr>
                <tr>
                  <td>1</td>
                  <td>{{listone.custno}}</td>
                  ...
                  <td>{{listone.tno}}</td>
                  <td>{{listone.custStatus}}</td>
                  <td>{{listone.openDate}}</td>
