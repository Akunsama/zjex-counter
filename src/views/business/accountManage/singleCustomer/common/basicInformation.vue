          ...
          <table class="table odd">
            <tbody>
              <tr>
                ...
                <td>客户类型</td>
                <td>{{listone.custTypeName}}</td>
                <td>
                  证件号码
                </td>
                <td>{{listone.certNo}}</td>
              </tr>
              <tr>
                <td>
                  资金账号
                </td>
                <td>{{listone.capitalAccount}}</td>
                <td>登记账号</td>
                <td>{{listone.account}}</td>
              </tr>
              <tr>
                <td>
                  客户名称
            ...
            <table class="table odd">
              <tbody>
                <tr>
                  ...
                  <td>{{listone.contactNo}}</td>
                  <td>联系手机</td>
                  <td>{{listone.contactPhone}}</td>
                </tr>
                <tr>
                  <td>
                    联系地址
                  </td>
                  <td colspan="4" class="tb2Td">{{listone.address}}</td>
